...
const sharedStyles = {
  ...
  tag: { display: 'inline-block', background: 'rgba(123,47,190,0.1)', color: '#7B2FBE', fontSize: '0.78rem', fontWeight: 700, padding: '3px 12px', borderRadius: 9999, marginBottom: 16, letterSpacing: '0.02em' },
  ...
  th: { background: '#252336', fontWeight: 600, padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' },
  td: { padding: '12px', border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.8)', lineHeight: 1.5 },
  quote: { borderLeft: '4px solid #0066FF', background: '#1A1827', padding: '16px 20px', borderRadius: '0 8px 8px 0', margin: '20px 0', fontStyle: 'italic', color: 'rgba(255,255,255,0.8)', fontSize: '1rem', lineHeight: 1.7 },
  cta: { marginTop: 56, background: '#1A1827', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, padding: '36px', textAlign: 'center' },
  ...
  footer: { background: '#7B2FBE', padding: '32px 24px', textAlign: 'center' },
