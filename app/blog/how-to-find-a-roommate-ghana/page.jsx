...
const s = {
  ...
  num: { display: 'inline-block', width: 28, height: 28, borderRadius: '50%', background: '#FF6B35', color: '#fff', fontWeight: 900, fontSize: 13, lineHeight: '28px', textAlign: 'center', marginRight: 12, flexShrink: 0 },
