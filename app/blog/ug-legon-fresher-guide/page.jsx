...
const s = {
  ...
  tag: { display: 'inline-block', background: 'rgba(244,196,48,0.1)', color: '#FF6B35', fontSize: '0.78rem', fontWeight: 700, padding: '3px 12px', borderRadius: 9999, marginBottom: 16, letterSpacing: '0.02em' },
