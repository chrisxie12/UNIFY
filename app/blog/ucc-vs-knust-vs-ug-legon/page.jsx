...
const s = {
  ...
  callout: { background: '#162347', borderLeft: '4px solid #0066FF', padding: '16px 20px', borderRadius: '0 8px 8px 0', margin: '24px 0', fontStyle: 'italic', color: 'rgba(255,255,255,0.8)', fontSize: '1rem', lineHeight: 1.7 },
  table: { width: '100%', borderCollapse: 'collapse', marginBottom: 24, fontSize: '0.95rem' },
  th: { background: '#1E2D5A', padding: '10px 12px', textAlign: 'left', fontWeight: 700, color: 'rgba(255,255,255,0.8)', border: '1px solid rgba(255,255,255,0.1)' },
  td: { padding: '10px 12px', border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.8)', verticalAlign: 'top' },
  cta: { marginTop: 56, background: '#162347', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, padding: '32px', textAlign: 'center' },
  ctaBtn: { display: 'inline-block', background: '#FF6B35', color: '#fff', fontWeight: 900, fontSize: 15, padding: '14px 28px', borderRadius: 999, textDecoration: 'none', marginTop: 16 },
