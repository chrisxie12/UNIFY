...
const s = {
  ...
  blogLink: { fontSize: 14, color: '#7B2FBE', textDecoration: 'none', fontWeight: 700 },
  ...
  callout: { background: '#1A1827', borderLeft: '4px solid #0066FF', padding: '16px 20px', borderRadius: '0 8px 8px 0', margin: '24px 0', fontStyle: 'italic', color: 'rgba(255,255,255,0.8)', fontSize: '1rem', lineHeight: 1.7 },
  table: { width: '100%', borderCollapse: 'collapse', marginBottom: 24, fontSize: '0.95rem' },
  th: { background: '#252336', padding: '10px 12px', textAlign: 'left', fontWeight: 700, color: 'rgba(255,255,255,0.8)', border: '1px solid rgba(255,255,255,0.1)' },
  td: { padding: '10px 12px', border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.8)', verticalAlign: 'top' },
  cta: { marginTop: 56, background: '#1A1827', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, padding: '32px', textAlign: 'center' },
