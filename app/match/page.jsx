    ...
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-sm px-4">
      <div className="bg-[#162347] border-2 border-[#FF6B35] shadow-[4px_4px_0px_#FF6B35] rounded-none p-4 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <a href="/#waitlist" className="inline-block mt-2 text-xs text-[#A8C4FF] hover:underline font-medium transition-colors">
            Join waitlist →
          </a>
        </div>
  ...
  return (
    <div className="relative min-h-screen p-4 md:p-6 antialiased"
      ...
      <div className="max-w-7xl mx-auto bg-[#0D1B3E] border-2 border-[#FF6B35] shadow-[6px_6px_0px_#FF6B35] rounded-none overflow-hidden">
        ...
        {/* ── FOOTER ── */}
        <footer className="bg-[#162347] border-t border-white/10 px-6 pt-8 pb-6">
