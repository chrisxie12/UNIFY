...
function WaitlistForm({ id, defaultSchool = '' }) {
  ...
  if (done) {
    ...
    const waText = encodeURIComponent(`Bro 👀 I just claimed my spot on UNIFY — Ghana's fresher network for ${schoolLabel}. Find roommates, link with coursemates, and join your campus hub before matriculation. It's free fr. Join here: https://unify-lake.vercel.app`);
    return (
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          Tell your SHS mates — send on WhatsApp
        </a>
      </div>
    );
  }
