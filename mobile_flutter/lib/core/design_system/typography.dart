...
/// All styles use Inter. Colours are intentionally omitted so they inherit
/// from ThemeData.textTheme (which handles dark mode automatically).
class UText {
  UText._();
  ...
  static TextStyle get btnS => GoogleFonts.inter(
        fontSize: 14, fontWeight: FontWeight.w600,
      );
}
